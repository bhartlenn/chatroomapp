...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference("Chatroom.count") do
      post chatrooms_url, params: { chatroom: { description: @chatroom.description, name: @chatroom.name } }
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { description: @chatroom.description, name: @chatroom.name } }
